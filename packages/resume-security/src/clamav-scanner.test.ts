...
test('parses a clean ClamAV response', () => {
...
test('parses an infected ClamAV response and preserves the signature name', () => {
...
test('treats unknown scanner responses as an error instead of clean', () => {
